...
public class LoginPanel extends javax.swing.JPanel {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(userTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        boolean check = false;
        try {
            check = auth(userTextField.getText(), String.valueOf(passwordField.getPassword()));
    ...
    private boolean auth(String username, String password) throws SQLException {
        ...
        try {
            ...
            while(res.next()) {
                if (matches(password, res.getString("password"))) {
                    check = true;
                }
            }
        } catch (SQLException e) {
